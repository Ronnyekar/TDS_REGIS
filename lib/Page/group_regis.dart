...
class GroupRegisPage extends StatefulWidget {
  const GroupRegisPage({super.key});

  @override
  State<GroupRegisPage> createState() => _GroupRegisPageState();
}

class _GroupRegisPageState extends State<GroupRegisPage> {
  @override
